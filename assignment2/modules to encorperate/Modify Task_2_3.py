...
arraySize = 30
array = [random.randint(10, 350) for _ in range(arraySize)]
barWidth = screenWidth // arraySize
...
def draw_array(array, color_positions=None):
    ...
    pygame.draw.rect(screen, (255, 255, 255), (0, 0, screenWidth, 50))
    
    text_line = "B: Bubble | S: Selection | M: Merge | R: Reset"
    text_surface = defaultFont.render(text_line, True, (0, 0, 0))

    text_rect = text_surface.get_rect(center=(screenWidth // 2, 30))
    ...
    for i, val in enumerate(array):
       ...
       pygame.draw.rect(screen, color, (i * barWidth, screenHeight - val, barWidth - 2, val))
