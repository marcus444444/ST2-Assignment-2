...
def main():
    ...
    while running:
        ...
        mode_text = FONT.render(f"Mode (T): {traversal_mode}", True, (50, 50, 50))
        ctrl_text = FONT.render("S: Search 20 | D: Delete 30 | T: Cycle Traversal", True, (80, 80, 80))
        screen.blit(mode_text, (20, 20))
        screen.blit(ctrl_text, (20, 50))

  
        draw_tree(bst.root, WIDTH // 2, 120, 150, search_path)
        ...
        if highlight_idx < len(current_traversal):
            ...
            highlight_recursive(bst.root, WIDTH // 2, 120, 150)
